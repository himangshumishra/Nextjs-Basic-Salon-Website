...
const Contact: React.FC = () => {
  return (
    <div className="flex items-center justify-center min-h-screen w-full" style={{ backgroundImage: "url('/images/contact.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="w-full lg:w-1/2 p-10 bg-black bg-opacity-75 flex flex-col justify-center text-center lg:text-left">
          ...
          <form className="space-y-4">
            <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
              <input type="text" placeholder="Name" className="w-full lg:w-1/2 p-2 bg-transparent border border-gray-500 rounded" />
              <input type="email" placeholder="Email" className="w-full lg:w-1/2 p-2 bg-transparent border border-gray-500 rounded" />
            </div>
            <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
              <input type="text" placeholder="Phone" className="w-full lg:w-1/2 p-2 bg-transparent border border-gray-500 rounded" />
              <input type="text" placeholder="Time" className="w-full lg:w-1/2 p-2 bg-transparent border border-gray-500 rounded" />
            </div>
            <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4">
            ...
            <button type="submit" className="w-full p-2 bg-yellow-500 text-black font-bold rounded">MAKE AN APPOINTMENT</button>
          </form>
        </div>
      </div>
    </div>
